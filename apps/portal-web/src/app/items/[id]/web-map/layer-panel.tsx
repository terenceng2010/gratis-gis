...
export function LayerPanel({
  ...
  function updateLayer(id: string, patch: Partial<WebMapLayer>) {
...
interface RowProps {
  ...
  onRemove: () => void;
  onPatch: (patch: Partial<WebMapLayer>) => void;
}
...
function SearchConfig({
  ...
  value: WebMapLayerSearch;
  fields: string[];
  onChange: (next: WebMapLayerSearch) => void;
}) {
  function patch(p: Partial<WebMapLayerSearch>) {
    onChange({ ...value, ...p });
  }
