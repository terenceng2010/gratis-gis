...
interface Props {
  item: Item;
  /** Retention window in days, used in the countdown + confirm copy. */
  retentionDays: number;
}

/**
 * One row in the items recently-deleted table. Handles restore + purge,
 * plus their loading/error state. Lives in the client because it
 * triggers fetches and needs router.refresh() afterward.
 */
export function ItemRow({ item, retentionDays }: Props) {
